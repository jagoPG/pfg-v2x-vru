...
\input{content/desarrollo/01-diseño_y_arquitectura_del_sistema}
\input{content/desarrollo/02-comunicacion_plataformas}
\input{content/desarrollo/03-formato_mensajes}
\input{content/desarrollo/04-nube_conductores}
\input{content/desarrollo/05-app_ciclistas}
\input{content/desarrollo/06-comunicacion_vehicular}