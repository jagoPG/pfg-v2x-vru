...
\begin{figure}[t]
	\includegraphics[scale=0.4]{1-gantt}
	\caption{Diagrama de Gantt - Especificaciones}
	\label{fig:gantt1}
\end{figure}
\begin{figure}
	\includegraphics[scale=0.4]{2-gantt}
	\caption{Diagrama de Gantt - Nube de conductores}
	\label{fig:gantt2}
\end{figure}
\begin{figure}
	\includegraphics[scale=0.4]{3-gantt}
	\caption{Diagrama de Gantt - Especificaciones}
	\label{fig:gantt3}
\end{figure}
\begin{figure}
	\includegraphics[scale=0.4]{4-gantt}
	\caption{Diagrama de Gantt - Aplicacion de ciclistas}
	\label{fig:gantt4}
\end{figure}
\begin{figure}
	\includegraphics[scale=0.4]{5-gantt}
	\caption{Diagrama de Gantt - HMI}
	\label{fig:gantt5}
\end{figure}
\begin{figure}
	\includegraphics[scale=0.4]{6-gantt}
	\caption{Diagrama de Gantt - Pruebas en la calle}
	\label{fig:gantt6}
\end{figure}
\begin{figure}
	\includegraphics[scale=0.4]{7-gantt}
