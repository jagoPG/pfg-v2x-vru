...
El ''heading'' o rumbo, es la dirección hacia la que se está dirigiendo un vehículo
con respecto al Norte (0 grados). En la figura \ref{figure:Bearing}, en el eje de
coordenadas cartesiano. Cada vez que se realice una operación que involucre los
ángulos, se emplea una función para mantenerlos en un rango de entre 0 a 360 grados.
