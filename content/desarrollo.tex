...
Se deberá crear diferentes aplicaciones: un servidor central que permita la comunicación entre diferentes tecnologías,
una app móvil para ciclistas y conductores, y aplicaciones para ser desplegadas en unidades \gls{obu} y \gls{rsu}.

\input{content/desarrollo/diseño_y_arquitectura_del_sistema}
\input{content/desarrollo/comunicacion_plataformas}
\input{content/desarrollo/formato_mensajes}
