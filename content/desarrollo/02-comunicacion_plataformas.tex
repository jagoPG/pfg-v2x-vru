...
Cuando se inicia una salida, cada vez que el ciclista recibe una posición actualizada
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.30]{DiagSecuencia-Ciclistas_Cloud}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.30]{DiagSecuencia-OBU_Cloud}
